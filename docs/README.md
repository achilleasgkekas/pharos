...
login, under the AGPL-3.0 license.
...
- **[Architecture](architecture.md)** — how the pieces fit: the Docker services and
  ...
  optional AI/scraper/searxng companions.
...
- **[FAQ](faq.md)** — common questions grouped by topic: self-hosting, privacy & data ownership, AI, storage & backups, cost &
