...
- Status: TODO (partial: onAccent `#000` literal migration → `C.onAccent` DONE 2026-07-01, 32 sites/10 screens· απομένει το actual `<Button>`/`<Chip>` component extraction, attended-preferred λόγω οπτικού verify)
