...
// against those three routes and refreshes.
//
...
// only owner/admin get the rename control and only the owner gets cancel/reactivate — mirrored
// client-side from canManage/isOwner so the panel never offers an action the API would reject.
// Additive + SaaS-only — the self-hosted app never mounts this route, so it stays byte-for-byte
// unchanged.
