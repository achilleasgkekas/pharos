...
const SERIALIZERS: { schema: string; file: string; fn: string }[] = [
  ...
  { schema: 'Subscription', file: 'app/api/v1/subscriptions/route.ts', fn: 'trim' },
  { schema: 'Voucher', file: 'app/api/v1/vouchers/route.ts', fn: 'trim' },
  { schema: 'Task', file: 'app/api/v1/tasks/route.ts', fn: 'trim' },
  { schema: 'Bill', file: 'app/api/v1/bills/route.ts', fn: 'trim' },
  { schema: 'GiftCard', file: 'app/api/v1/giftcards/route.ts', fn: 'trim' },
  { schema: 'Goal', file: 'app/api/v1/goals/route.ts', fn: 'trim' },
  { schema: 'LoyaltyCard', file: 'app/api/v1/loyaltycards/route.ts', fn: 'trim' },
