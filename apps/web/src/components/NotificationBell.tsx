...
const KIND_ICON: Record<NotifKind, typeof Bell> = { deal: Tag, warranty: ShieldCheck, installment: CreditCard, pricehike: TrendingUp, trialend: AlarmClock, giftcard: Wallet, bill: FileText, maintenance: Wrench, lending: Handshake, claim: PackageOpen, system: Bell };
