...
import { Bell, Tag, ShieldCheck, CreditCard, TrendingUp, AlarmClock, Wallet, X } from 'lucide-react';
...
const KIND_ICON: Record<NotifKind, typeof Bell> = { deal: Tag, warranty: ShieldCheck, installment: CreditCard, pricehike: TrendingUp, trialend: AlarmClock, giftcard: Wallet, system: Bell };
