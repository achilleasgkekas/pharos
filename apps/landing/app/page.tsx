...
const ROADMAP: {
...
}[] = [
  {
    ...
    items: [
      ...
      'Opt-in multi-currency for expenses, income, receipts & subscriptions',
    ],
  },
  {
    phase: 'Building',
