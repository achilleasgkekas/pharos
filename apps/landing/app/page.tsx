...
const ROADMAP: {
...
}[] = [
  {
    ...
    items: [
      ...
      'Opt-in multi-currency for expenses, income, receipts, subscriptions, items & statements',
    ],
  },
  {
    phase: 'Building',
