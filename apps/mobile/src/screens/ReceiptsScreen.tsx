...
const s = StyleSheet.create({
  ...
  scan: { margin: 16, marginBottom: 8, borderRadius: RADIUS.md, borderWidth: 1, borderColor: C.border, backgroundColor: C.surface2, paddingVertical: 12, alignItems: 'center' },
  scanText: { color: C.cyan, fontSize: 15, fontWeight: '600' },
  row: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: RADIUS.lg, padding: 12, marginBottom: 10 },
  ...
  bigImg: { width: '100%', height: 260, borderRadius: RADIUS.md, backgroundColor: C.surface, marginBottom: 14 },
  ...
  sumBtn: { borderWidth: 1, borderColor: C.cyan, borderRadius: RADIUS.sm, paddingVertical: 10, paddingHorizontal: 14, marginBottom: 0 },
  ...
  lineEdit: { borderWidth: 1, borderColor: C.border, borderRadius: RADIUS.md, padding: 10, marginTop: 8, backgroundColor: C.surface },
  ...
  libBtn: { marginTop: 18, borderWidth: 1, borderColor: C.accent, borderRadius: RADIUS.md, paddingVertical: 12, alignItems: 'center' },
