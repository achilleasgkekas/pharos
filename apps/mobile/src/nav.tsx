...
const GROUPS: { title: string; items: { key: ScreenKey; label: string }[] }[] = [
  ...
  { title: 'Money', items: [{ key: 'receipts', label: 'Receipts' }, { key: 'expenses', label: 'Expenses' }, { key: 'income', label: 'Income' }, { key: 'subscriptions', label: 'Subscriptions' }] },
...
const s = StyleSheet.create({
  ...
  brand: { color: C.text, fontSize: 20, fontWeight: '800', letterSpacing: 3, paddingHorizontal: 10, marginBottom: 16 },
