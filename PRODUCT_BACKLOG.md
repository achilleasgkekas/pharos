...
> - **P96. Admin center, γύρος προτάσεων** — M — SaaS. Ο Αχιλλέας: «χρειαζόμαστε περισσότερο
>   έλεγχο». ΔΕΝ είναι έτοιμο για χτίσιμο, θέλει πρώτα πρόταση και έγκριση. **Προϋπόθεση που δεν
>   πρέπει να παρακαμφθεί:** σήμερα το audit trail έχει **δύο εγγραφές συνολικά** και δεν
>   καταγράφει ούτε συνδέσεις ούτε πρόσβαση στο `/admin`, και ο caddy δεν κρατά access log. Χωρίς
>   αυτά, κάθε νέο κουμπί στο admin είναι **έλεγχος χωρίς λογοδοσία**. Η πρόταση να ξεκινά από την
>   καταγραφή, όχι από τα κουμπιά.
